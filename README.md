...
Check each dataset's licence before use or redistribution. Keep real-site captures to test accounts and synthetic/consented data; never commit raw personal screenshots to the repository.
