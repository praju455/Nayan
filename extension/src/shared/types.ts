...
export type AgentAction = Readonly<{ action: "click" | "type" | "scroll" | "select" | "select_recipient" | "focus" | "navigate" | "wait" | "done" | "confirm_needed"; targetId?: string; valueToken?: string; destination?: string; deltaY?: number; message?: string; confidence: number; reason: string }>;
