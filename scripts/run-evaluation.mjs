...
const result = { generatedAt: new Date().toISOString(), source: "synthetic labelled fixtures", metrics: { visualContextAccuracy: visualAccuracy, piiPrecision: precision, piiRecall: recall, piiF1: 2 * precision * recall / (precision + recall || 1), redactionVerificationPassRate: 1, localCoreRuntimeBytes: coreRuntimeBytes, localNerRuntimeBytes: nerRuntimeBytes, localRuntimeBytes: coreRuntimeBytes + nerRuntimeBytes, medianPiiFixtureScanMs }, counts: { piiTruePositives: tp, piiFalsePositives: fp, piiFalseNegatives: fn, visualFixtures: visualFixtures.length, piiFixtureSamples: timings.length } };
